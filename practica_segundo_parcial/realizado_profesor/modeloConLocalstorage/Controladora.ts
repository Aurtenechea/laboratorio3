...
namespace Clases
{
    export class Controladora
    {
        public static AgregarAuto():void
        {
            ...
            /*  si el hidden index esta seteado es porque se quiere modificar.
                Entonces prviamente se requiere borrar el auto especifico.
                (de un cierto indice) */
            if(index !== "")
            {
            ...
            /*  agrego un auto al array de autos. */
